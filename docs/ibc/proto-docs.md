...
- [grandpa/v1/grandpa.proto](#grandpa/v1/grandpa.proto)
    ...
    - [SolochainHeader](#ibc.lightclients.grandpa.v1.SolochainHeader)
    - [SolochainHeaderMap](#ibc.lightclients.grandpa.v1.SolochainHeaderMap)
    - [SolochainHeaderMap.SolochainHeaderMapEntry](#ibc.lightclients.grandpa.v1.SolochainHeaderMap.SolochainHeaderMapEntry)
...
<a name="grandpa/v1/grandpa.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## grandpa/v1/grandpa.proto
...
| `solochain_header_map` | [SolochainHeaderMap](#ibc.lightclients.grandpa.v1.SolochainHeaderMap) |  | solochain headers and their proofs |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `parachain_id` | [uint32](#uint32) |  | para id |
...
<a name="ibc.lightclients.grandpa.v1.SolochainHeader"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `block_header` | [bytes](#bytes) |  | scale-encoded solochain header bytes |
| `timestamp` | [StateProof](#ibc.lightclients.grandpa.v1.StateProof) |  | timestamp and proof |
...
<a name="ibc.lightclients.grandpa.v1.SolochainHeaderMap"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `solochain_header_map` | [SolochainHeaderMap.SolochainHeaderMapEntry](#ibc.lightclients.grandpa.v1.SolochainHeaderMap.SolochainHeaderMapEntry) | repeated | LatestMMR latest_mmr = 1; map<blocknumber,scale-encoded blockheader>
...
<a name="ibc.lightclients.grandpa.v1.SolochainHeaderMap.SolochainHeaderMapEntry"></a>

### SolochainHeaderMap.SolochainHeaderMapEntry
...
| ----- | ---- | ----- | ----------- |
| `key` | [uint32](#uint32) |  |  |
| `value` | [SolochainHeader](#ibc.lightclients.grandpa.v1.SolochainHeader) |  |  |
