...
type ClientState struct {
	...
	LatestBeefyHeight types.Height `protobuf:"bytes,4,opt,name=latest_beefy_height,json=latestBeefyHeight,proto3" json:"latest_beefy_height"`
	// Latest mmr root hash
	LatestMmrRoot []byte `protobuf:"bytes,5,opt,name=latest_mmr_root,json=latestMmrRoot,proto3" json:"latest_mmr_root,omitempty"`
	// latest subchain or parachain height
	LatestChainHeight types.Height `protobuf:"bytes,6,opt,name=latest_chain_height,json=latestChainHeight,proto3" json:"latest_chain_height"`
	// Block height when the client was frozen due to a misbehaviour
	FrozenHeight types.Height `protobuf:"bytes,7,opt,name=frozen_height,json=frozenHeight,proto3" json:"frozen_height"`
	// latest authority set
	LatestAuthoritySet BeefyAuthoritySet `protobuf:"bytes,8,opt,name=latest_authority_set,json=latestAuthoritySet,proto3" json:"latest_authority_set"`
}
...
type SubchainHeaders struct {
	...
	MmrLeavesAndBatchProof MMRLeavesAndBatchProof `protobuf:"bytes,2,opt,name=mmr_leaves_and_batch_proof,json=mmrLeavesAndBatchProof,proto3" json:"mmr_leaves_and_batch_proof"`
}
...
type Header struct {
	// the latest mmr data
	BeefyMmr *BeefyMMR `protobuf:"bytes,1,opt,name=beefy_mmr,json=beefyMmr,proto3" json:"beefy_mmr,omitempty"`
	// only one header
	//
...
var fileDescriptor_cd16ccf01137b53b = []byte{
	...
	,
}
...
func (m *ClientState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.LatestAuthoritySet.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x32
	if len(m.LatestMmrRoot) > 0 {
		i -= len(m.LatestMmrRoot)
		copy(dAtA[i:], m.LatestMmrRoot)
		i = encodeVarintGrandpa(dAtA, i, uint64(len(m.LatestMmrRoot)))
		i--
		dAtA[i] = 0x2a
	}
	{
...
func (m *MMRBatchProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LeafIndexes) > 0 {
		dAtA12 := make([]byte, len(m.LeafIndexes)*10)
		var j11 int
		...
		i = encodeVarintGrandpa(dAtA, i, uint64(j11))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ClientState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatestMmrRoot", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LatestMmrRoot = append(m.LatestMmrRoot[:0], dAtA[iNdEx:postIndex]...)
			if m.LatestMmrRoot == nil {
				m.LatestMmrRoot = []byte{}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatestAuthoritySet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LatestAuthoritySet.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
