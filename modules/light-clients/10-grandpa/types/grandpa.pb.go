...
func init() {
	...
	proto.RegisterType((*Fraction)(nil), "ibc.lightclients.grandpa.v1.Fraction")
}

func init() {
	proto.RegisterFile("ibc/lightclients/grandpa/v1/grandpa.proto", fileDescriptor_c6d6cf2b288949be)
}
