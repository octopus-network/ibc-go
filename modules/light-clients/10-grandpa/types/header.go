...
func (h Header) ValidateBasic() error {
	if h.SignedHeader == nil {
		return sdkerrors.Wrap(clienttypes.ErrInvalidHeader, "grandpa signed header cannot be nil")
	}
	if h.Header == nil {
	...
	if err != nil {
		return sdkerrors.Wrap(err, "header is not a grandpa header")
	}
	...
	if err != nil {
		return sdkerrors.Wrap(err, "validator set is not grandpa validator set")
	}
