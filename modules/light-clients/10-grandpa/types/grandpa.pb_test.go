...
var solochainHeaderMap = ibcgptypes.SolochainHeaderMap{
	SolochainHeaderMap: map[uint32]ibcgptypes.SolochainHeader{
		15228: {
...
var gpHeader = ibcgptypes.Header{
	BeefyMmr: beefyMMR,
	Message: &ibcgptypes.Header_SolochainHeaderMap{
