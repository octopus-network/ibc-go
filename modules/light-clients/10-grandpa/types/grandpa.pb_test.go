...
func (suite *GrandpaTestSuite) TestMsgClientState() {
	...
	// // suite.header = suite.chainA.CreateTMClientHeader(chainID, int64(height.RevisionHeight),
	// // 	heightMinus1, suite.now, suite.valSet, suite.valSet, []tmtypes.PrivValidator{suite.privVal}, &ibcgptypes.Header{})
