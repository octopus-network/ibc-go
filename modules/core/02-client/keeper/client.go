...
func (k Keeper) CreateClient(
	...
	k.Logger(ctx).Debug("create client ID: ", clientID, "client state height: ", clientState.GetLatestHeight())
...
func (k Keeper) UpdateClient(ctx sdk.Context, clientID string, header exported.Header) error {
	...
	k.Logger(ctx).Debug("newClientState: ", newClientState, "newConsensusState: ", newConsensusState)
