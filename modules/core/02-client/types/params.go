...
var (
	// DefaultAllowedClients are "06-solomachine" , "07-tendermint" and "10-grandpa"
	DefaultAllowedClients = []string{exported.Solomachine, exported.Tendermint, exported.Grandpa}
